export class BlockFace {
    ...
    public static readonly EAST_NORTH_EAST: BlockFace = new BlockFace('EAST_NORTH_EAST')!;
    public static readonly EAST_SOUTH_EAST: BlockFace = new BlockFace('EAST_SOUTH_EAST')!;
    ...
    public static readonly NORTH_NORTH_EAST: BlockFace = new BlockFace('NORTH_NORTH_EAST')!;
    public static readonly NORTH_NORTH_WEST: BlockFace = new BlockFace('NORTH_NORTH_WEST')!;
    ...
    public static readonly SOUTH_SOUTH_EAST: BlockFace = new BlockFace('SOUTH_SOUTH_EAST')!;
    public static readonly SOUTH_SOUTH_WEST: BlockFace = new BlockFace('SOUTH_SOUTH_WEST')!;
    ...
    public static readonly WEST_NORTH_WEST: BlockFace = new BlockFace('WEST_NORTH_WEST')!;
    public static readonly WEST_SOUTH_WEST: BlockFace = new BlockFace('WEST_SOUTH_WEST')!;
    ...
    public static named(name: string): BlockFace | null {
        ...
        if ((name in BlockFace) && ((BlockFace as any)[name] instanceof BlockFace)) return (BlockFace as any)[name];
