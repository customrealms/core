...
export class HumanEntity {
    ...
    public getBedLocation(): Location | null {
        return Location.fromJava(
            this.toJava().getBedLocation()
        );
    }
     ...
     */
    public openEnchanting(location: Location | null, force: boolean): InventoryView | null {
     ...
     */
    public openInventory(inventory: InventoryView | Inventory): void | InventoryView {
     ...
     */
    public openWorkbench(location: Location | null, force: boolean): InventoryView | null {
        // TODO: Not implemented
        return null as any;
    }
     ...
     */
    public setBedSpawnLocation(location: Location | null, force?: boolean): void {
    ...
    public setGameMode(gamemode: GameMode): void {
        const javaGameMode = Java.resolve('org.bukkit.GameMode').valueOf(gamemode);
     ...
     */
    public setWindowProperty(property: InventoryViewProperty, value: number): boolean {
        const javaProp = Java
