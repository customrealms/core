 ...
 */
export type CommandFn = (player: Player, call: CommandCall) => void | Promise<void>
...
export class ServerCommands {
    ...
    public static register(patterns: string[], handler: CommandFn): CommandHandle;

    public static register(p: string | string[], handler: CommandFn): CommandHandle {
    ...
    private static root_register(): void {
        ...
        this.root_handle = BukkitCommands.register((_player, message) => {
            ...
            for (let command of this.command_runners) {
