...
export class ServerEvents {
     ...
     */
    public static register<T extends Event>(event_class: Constructor<T> & BukkitEventWrapper, handler: (event: T) => void): EventHandle | null {
        ...
        const handle = BukkitEvents.register(classpath, (_event: Java.Value) => {
